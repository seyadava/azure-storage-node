...
var storageDnsSuffix = process.env.AZURE_STORAGE_DNS_SUFFIX || 'redmond.ext-n22r1002.masd.stbtest.microsoft.com';
...
var Constants = {
  ...
  */
  HeaderConstants: {
    ...
    * @type {string}
    */
    TARGET_STORAGE_VERSION: '2017-04-17' || process.env.AZURE_STORAGE_API_VERSION,
